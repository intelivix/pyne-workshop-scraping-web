...
class Team(models.Model):
    name = models.CharField(max_length=20)
    icon = ImageField(upload_to=get_image_path, blank=True, null=True)
    titles = models.ManyToManyField(
        Championship,
        through='Title',
        through_fields=('championship', 'first_place', 'second_place'),
    )
...
class Event(models.Model):
    ...
    gametime = models.IntegerField(min_value=0, max_value=150)
